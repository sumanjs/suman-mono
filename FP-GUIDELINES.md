...
check was introduced: **2,066 findings across 304 files
and 33,257 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `TS002` | 580 | warn | immutable values | mutable `let` binding |
| `TS005` | 455 | warn | explicit inputs | `any` escapes the type system |
| `TS008` | 400 | warn | effects pushed outward | direct console effect in library code |
| `TS009` | 193 | warn | explicit inputs | ambient impurity (clock / randomness / env) read inside pure code |
| `TS004` | 189 | warn | pure transformations | in-place array mutation |
| `TS006` | 151 | warn | typed errors | `throw` as control flow |
| `TS003` | 82 | error | explicit state transitions | module-level mutable binding |
...
*immutable values* · 580 occurrences at baseline
...
*explicit inputs* · 455 occurrences at baseline
...
*effects pushed outward* · 400 occurrences at baseline
...
*explicit inputs* · 193 occurrences at baseline
...
*pure transformations* · 189 occurrences at baseline
...
*typed errors* · 151 occurrences at baseline
...
*explicit state transitions* · 82 occurrences at baseline
