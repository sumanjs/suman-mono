...
exports.utils = {
    ...
    validatePlugin: function (v, k) {
        try {
            ...
            logging_1.default.error('The following suman-watch-plugin is malformed =>\n', chalk_1.default.magenta.bold(util.inspect(v)));
            throw err;
        }
        return v;
    },
    ...
    getValueViaSemverVersion: function (version, pluginName, values) {
        try {
            ...
            logging_1.default.error("the semver version passed is not valid => '" + version + "', while looking a version of plugin with name '" + pluginName + "'.");
        }
        var prev;
